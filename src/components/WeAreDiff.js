  ...
  return (
    <section className="we-are-diff-layout">
      <div className="we-are-diff-block" id="we-are-diff-id">
        ...
        <p className="we-are-diff-block__description">We are the best when it goes to remote team extension because we
          own <span className="mark-diff">CoWorking Network</span>.<br/><br/>Developers we hire become our coworking
            clients so there is no need for us to overcharge you like other SE companies can do.
          </p>
      </div>
    </section>
  );
